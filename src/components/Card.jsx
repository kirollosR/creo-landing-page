...
const Card = () => {
  return (
    <div className="max-w-md mx-auto bg-[#1263B0] text-white font-poppins overflow-hidden md:max-w-2xl">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="order-1 md:order-1 p-8 md:flex-1 md:flex md:flex-col md:justify-center md:items-start">
          ...
          <div className="flex justify-center md:justify-start md:w-3/4 md:pb-5">
            <img className="" src={podcastStudio} alt="Logo" />
          </div>
          ...
          <div className="order-4 md:order-3 mt-4 flex justify-center md:justify-start">
            <button className="bg-[#E96759] text-white py-2 px-4 hover:bg-opacity-80 transition duration-300 w-40 md:text-sm">
