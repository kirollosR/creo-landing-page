...
const CreatedToCreate = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-primeColor text-white font-poppins p-4">
      {/* Left Column */}
      ...
      <div className="pt-2 sm:pt-12 md:pt-44 pr-4 sm:pr-8 md:pr-20 text-center md:text-left">
        <p className="text-base sm:text-lg md:text-2xl pb-6 sm:pb-8 md:pb-16">
          Stunning Images, Captivating Videos,<br /> Perfect Audio Content, Eye
          Catching Designs.
        </p>
