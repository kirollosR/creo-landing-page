...
const EquipmentsLayout = () => {
  return (
    <div className="flex flex-col items-center bg-[#1263B0] font-poppins pb-20">
      {/* Title for the Equipments Section */}
      <h2 className="text-4xl md:relative md:top-24 md:pr-0 md:text-7xl font-bold text-[#E96759] mb-6">
        EQUIPMENTS
      </h2>
